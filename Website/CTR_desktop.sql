...
-- Find all webpages present in desktop website
...
-- Get page visit count for all website pages

drop temporary table if exists web_pages_visited;

create temporary table web_pages_visited
select 
	ws.website_session_id,
    ws.created_at,
    wp.pageview_url,
    CASE WHEN wp.pageview_url IN ('/home', '/lander-2', '/lander-4', '/lander-5') THEN 'lander/home page' 
...
select * from web_pages_visited;


-- -- Calculate CTR for Website
